...
export async function getStaticProps(context) {
  ...
  const suggestions = await client.getEntries({content_type: "post", 'fields.category[match]': "movie-reviews", 'fields.slug[ne]': context.params.slug, 'order': "-fields.date", 'limit': "4" }).then((response) => response.items);
